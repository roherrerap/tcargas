        ...
        if (usernameUSR != null){
            if (usernameUSR.getPasswordUser().equals(password)){
                ...
                if (vehicles != null){
                    ...
                    rob.setData(newTransaction.getIdVschedule().toString());
                    return rob;
                } else {
        ...
        if (usernameUSR != null){
            if (usernameUSR.getPasswordUser().equals(password)){
                ...
                if (vehicleschedules != null){
                    rob.setSuccess(true);
                    rob.setErr_message("Transacción Satisfactoria");
                    rob.setData(vehicleschedules.getTravelassignedVschedule()+vehicleschedules.getTimefinalassignedVschedule().toString());
